...
----
  <ul>
     <li>multiple 多选功能。</li>
     <li>condition-props控制树形和级联的收束条件，condition-props为truthy树形列表用户不可选。</li>
...
---
  <ul>
     ...
     <li>有时树形和级联的收束条件可能不同，我们提供cascade-condition-props控制级联的收束条件。cascade-condition-props为truthy级联中显示该项。</li>
